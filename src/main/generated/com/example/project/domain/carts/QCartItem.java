...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 1070387666L;
    ...
    public final com.example.project.domain.items.QItem item;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new com.example.project.domain.items.QItem(forProperty("item")) : null;
    }
